  ...
  const updateMarker = (arr, i) => {
    ...
    if (sensorRead1 == "0") {
      Microsoft.Maps.loadModule('Microsoft.Maps.GeoJson', function() {
        Microsoft.Maps.GeoJson.readFromUrl(`Location/locations${i}a.json`,
          function(shapes) {
      ...
      Microsoft.Maps.loadModule('Microsoft.Maps.GeoJson', function() {
        Microsoft.Maps.GeoJson.readFromUrl(`Location/locations${i}c.json`,
          function(shapes) {
            map.entities.push(shapes,);
          });
      });
      ...
      Microsoft.Maps.loadModule('Microsoft.Maps.GeoJson', function() {
        Microsoft.Maps.GeoJson.readFromUrl(`Location/locations${i}b.json`,
          function(shapes) {
            map.entities.push(shapes,);
          });
      });
