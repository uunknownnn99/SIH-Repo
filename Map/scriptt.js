  ...
  const updateMarker = (arr) => {
    ...
    if (sensorRead == "0") {
      Microsoft.Maps.loadModule('Microsoft.Maps.GeoJson', function() {
        Microsoft.Maps.GeoJson.readFromUrl('Map/locations1.json',
          function(shapes) {
      ...
      Microsoft.Maps.loadModule('Microsoft.Maps.GeoJson', function() {
        Microsoft.Maps.GeoJson.readFromUrl('Map/locations3.json',
          function(shapes) {
            map.entities.push(shapes,);
          });
      });
      ...
      Microsoft.Maps.loadModule('Microsoft.Maps.GeoJson', function() {
        Microsoft.Maps.GeoJson.readFromUrl('Map/locations2.json',
          function(shapes) {
            map.entities.push(shapes,);
          });
      });
